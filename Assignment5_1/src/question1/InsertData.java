...
public class InsertData {
    ...
    public void insertToPassenger() throws SQLException {
        //insert data to Passenger Table
        try {
            st.execute("INSERT INTO PASSENGER(PASSENGERID,PASSENGERNAME,HOMEADDRESS,NATIONALITY,DOB,AGE) VALUES (1,'Steven','WAYMOUTH','CHINA','1997-01-02',21)");
            st.execute("INSERT INTO PASSENGER(PASSENGERID,PASSENGERNAME,HOMEADDRESS,NATIONALITY,DOB,AGE) VALUES (2,'James','WAYMOUTH','CHINA','1991-01-03',27)");
            st.execute("INSERT INTO PASSENGER(PASSENGERID,PASSENGERNAME,HOMEADDRESS,NATIONALITY,DOB,AGE) VALUES (3,'Durant','WAYMOUTH','AUSTRALIA','1978-01-04',40)");
            st.execute("INSERT INTO PASSENGER(PASSENGERID,PASSENGERNAME,HOMEADDRESS,NATIONALITY,DOB,AGE) VALUES (4,'Kobe','WAYMOUTH','AUSTRALIA','2001-01-05',17)");
            st.execute("INSERT INTO PASSENGER(PASSENGERID,PASSENGERNAME,HOMEADDRESS,NATIONALITY,DOB,AGE) VALUES (5,'Iven','WAYMOUTH','U.S.','1997-01-06',21)");
            st.execute("INSERT INTO PASSENGER(PASSENGERID,PASSENGERNAME,HOMEADDRESS,NATIONALITY,DOB,AGE) VALUES (6,'Love','WAYMOUTH','U.S.','2001-01-07',17)");
